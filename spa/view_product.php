...
<body>
    ...
    input {
    pointer-events: none; /* Disables click and interaction */
    user-select: none; /* Prevents text selection */
    background-color: #f0f0f0; /* Optional: Light gray background to indicate it's disabled */
    color: #666; /* Optional: Dimmed text color */
        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="card p-4 card_form_container">
                    <h3 class="mb-4"><i class="fas fa-plus"></i> View Product</h3>
